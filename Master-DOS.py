...
parser = argparse.ArgumentParser(
    description="Master-DOS, uma simples ferramenta de Stress DOS em sites e alvos"
)
parser.add_argument("host", nargs="?", help="IP do host a ser atacado")
parser.add_argument(
    "-p", "--port", default=80, help="Porta de ataque (normalmente pode ser a 80)", type=int
)
parser.add_argument(
    "-s",
    "--sockets",
    default=150,
    help="Numero de sockets a serem usados no ataque",
    type=int,
)
parser.add_argument(
